      ...
      <div className={opensans.className}>
        <div className="grid justify-items-center md:grid-cols-2">
          <div style={{ marginBottom: 50, marginLeft: 300, width: 600 }}>
            <Card href="#" className="max-w-lg rounded-3xl bg-pink_lite mr-100">
              ...
              <p className="font-normal text-black-700 dark:text-gray-400">
                ...
                las ideas nuevas que nuestros clientes tienen son nuestra mejor
                receta, nosotros nos comprometemos a realizar los mejores
                productos donde la calidad es lo que nos diferencia de la
                competencia. Compartiendo no solo la mejor calidad en el
          ...
          <div style={{ marginRight: 100, marginBottom: 50 }}>
            <Card href="#" className="max-w-lg rounded-3xl bg-blue_card mr-100">
              <h5 className="text-2xl text-center font-bold tracking-tight text-gray-900 dark:text-white">
                Vision
              </h5>
              <p className="font-normal text-black-700 dark:text-gray-400">
          ...
          <Card style={{ background: "#ffeecc", height: 1020 }}>
            ...
            <CardContent>
              ...
              <Typography className={opensans.className}>
                ...
                desarrollar su carrera profesional en el ámbito tecnológico. Soy
                una persona detallista, orientada al trabajo en equipo, y estoy
                ansiosa por formar parte de un equipo de desarrollo donde pueda
                poner a prueba mis habilidades y conocimientos técnicos.
              </Typography>
            </CardContent>
            <CardActions>
              <Button
          ...
          <Card style={{ background: "#f3ccf3", height: 1020 }}>
            ...
            <CardContent>
              ...
              <Typography className={opensans.className}>
                ...
                mi capacidad para solucionar problemas. Busco un puesto
            ...
            <Card style={{ background: "#ffd1bd", height: 1020 }}>
              ...
              <CardContent>
                ...
                <Typography className={opensans.className}>
                  ...
                  desarrollo de software. Mi formación incluye una licenciatura
                  en Ingeniería en Sistemas Computacionales y una sólida
                  capacitación en lenguajes de programación como Python y Java,
                  así como en tecnologías web como HTML, JavaScript y PHP.Me
                  destaco por mi atención al detalle, mi capacidad para resolver
                  problemas y mi motivación para aprender y crecer en un entorno
