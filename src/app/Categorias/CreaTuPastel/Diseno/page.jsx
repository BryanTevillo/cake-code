        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 md:py-10 md:px-10 bg-[#eef6fb] justify-items-center gap-4 ">
          <div className="mt-20 ">
            <Card className="w-[350px] md:w-[400px] md:h-[480px] xl:w-[350px] border-none rounded-none ">
              ...
              <p
                className={[
                  opensans.className +
                    " text-2xl md:text-3xl xl:text-2xl font-normal md:text-center text-gray-700 dark:text-gray-400",
                ]}
              >
                Buttercream rosa con hojas de oro comestible
              </p>
          ...
          <div className=" mt-10  md:mt-20  ">
            <Card className=" w-[350px] md:w-[400px] md:h-[480px] xl:w-[350px] border-none rounded-none  ">
              ...
              >
                Flores rosas (Stencil) y oro comestible
              </p>
          ...
          <div className=" mt-10  md:mt-20 ">
            <Card className=" w-[350px]  md:w-[400px] md:h-[480px] xl:w-[350px] border-none rounded-none  ">
              ...
              >
                Buttercream de vainilla con flores de colores
              </p>
          ...
          <div className="mb-10 mt-10  md:mt-20 ">
            <Card className=" w-[350px]  md:w-[400px] md:h-[480px] xl:w-[350px] border-none rounded-none  ">
              ...
              >
                Buttercream de cookies n' cream
              </p>
