  ...
  return (
    <>
      <main>
        ...
        >
          ...
          <div className="place-content-around text-justify text-2xl w-5/6 mt-36 mb-10">
            <p>
              ...
              eficiente para usted! Hicimos un sistema instantáneo para usted,
              en el que puede elegir TODO, desde sabores, diseños y toppings.
            </p>
        ...
        <div
          className="grid md:grid-cols-3 grid-cols-3 gap-4  md:place-content-around"
          id="subtitulo"
        >
