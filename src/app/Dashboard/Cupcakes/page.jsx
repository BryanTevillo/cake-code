...
function Cupcakes() {
  return (
    <>
      <h1 className="text-center font-bold text-[5rem]">Lista Cupcakes</h1>
      ...
      <div>
        <div className="grid md:grid-cols-2 sm:grid-cols-1 ">
          ...
          <div className="grid md:justify-items-stretch sm:justify-content-center ">
            <Button
              gradientDuoTone="purpleToBlue"
              className="max-w-[11rem] md:justify-self-end sm:justify-self-center"
            >
              + Agregar producto
            </Button>
          </div>
